...
class Users extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['username', 'password_hash', 'password_reset_token', 'email', 'last_name', 'first_name', 'patronymic', 'verification_token'], 'string', 'max' => 255],
    ...
    public static function getStatusesArray()
    {
        return [
            ...
            self::STATUS_INACTIVE => 'Ожидает подтверждения',
        ];
    }
